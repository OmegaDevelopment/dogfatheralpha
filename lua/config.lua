...
local _M =
{
	...
	postgres = -- Not implemented
	{
		...
		database = os.getenv('POSTGRES_DB') or 'Dogfather',
	},
	redis =
	{
	...
	channel = os.getenv('CHANNEL') or '@GamerPupsInfo',
	source_code = os.getenv('SOURCE') or 'A revamp of https://github.com/RememberTheAir/GroupButler/tree/beta link to revamp soon to come',
	help_group = os.getenv('HELP_GROUP') or 'Contact @PupLucky',
	...
	bot_keys = {
    d4 = {'bot:realms', 'bot:users', 'bc:err429'},
